...
#
# Script generated by Vivado on Sat Mar 22 15:05:50 +0800 2025
...
# script info
echo -e "inst_rom.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot inst_rom xil_defaultlib.inst_rom xil_defaultlib.glbl -log elaborate.log
}
